  ...
  let state = { goals: [], habits: [], habitSort: { mode:'none', dir:'desc' }, countdowns: [], mantras: [], motivation: { categories: [], videos: [], pin: '', pinnedCategoryId: '', catOrder: 'added', speakMantra: false }, checklists: [], checklistExp: 0,
    ...
    fitness: { currentWeight:'', targetWeight:'', height:'', age:'', sex:'male', activity:'1.55', pace:'0.5', unit:'kg', weightLog:[], calorieLog:[], kcalOffset:1, activityLog:[], measureLog:[], progressPhotos:[], dreamPhoto:null, sleepLog:[], sleepGoal:8, sleepBedGoal:'', sleepPending:null, sleepDozeMins:30 },
